...
public class GuiLogin extends GuiScreen {
	...
	public void initGui() {
		...
		if (label.equals("Register")) {
			textField = new GuiTextField(fontRenderer, width / 2 - 100, 60,
					200, 20);
			...
			if (Vars.debug)
				passField = new GuiTextField(fontRenderer, width / 2 - 100, 60,
						200, 20);
			else
				passField = new GuiPasswordField(fontRenderer, width / 2 - 100,
						60, 200, 20);
